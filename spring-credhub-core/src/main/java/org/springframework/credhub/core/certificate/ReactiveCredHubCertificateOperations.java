...
public interface ReactiveCredHubCertificateOperations {
	 ...
	 */
	Mono<CertificateCredentialDetails> regenerate(String id, boolean setAsTransitional,
			boolean allowTransitionalParentToSign, Integer keyLength, Integer duration, Map<String, Object> metadata);
	 ...
	 */
	Mono<CertificateCredentialDetails> deleteVersion(String id, String versionId);
