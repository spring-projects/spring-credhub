 ...
 * @see <a href=
 * "https://docs.cloudfoundry.org/api/credhub/version/main/#_generate_a_rsa_credential">CredHub
 * API docs: Generate an RSA Credential</a>
 */
public class RsaParametersRequest extends ParametersRequest<RsaParameters> {
	 ...
	 * construct a {@link RsaParametersRequest}.
	 * @return a builder
	 */
