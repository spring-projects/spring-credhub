...
/**
 * The details of a request to write a new or update an existing {@link UserCredential} in
 * CredHub.
 *
...
public class UserCredentialRequest extends CredentialRequest<UserCredential> {
	 ...
	 * construct a {@link UserCredentialRequest}.
	 * @return a builder
	 */
