...
class CredentialPermissionsUnitTests extends JsonParsingUnitTestsBase {

	@Test
	void deserializePermissions() {
		String json = """
				{
		...
		assertThat(permission.getActor().getAuthType()).isEqualTo(ActorType.USER);
	...
	@Test
	void deserializeWithNoPermissions() {
		String json = """
				{
					"permissions": []
				}
