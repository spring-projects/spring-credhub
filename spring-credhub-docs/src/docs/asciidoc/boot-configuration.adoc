...
:spring-boot-oauth: https://docs.spring.io/spring-boot/{spring-boot-version}/reference/web/spring-security.html#web.security.oauth2.client
:spring-boot-external-config: https://docs.spring.io/spring-boot/{spring-boot-version}/reference/features/external-config.html#features.external-config.files
:spring-security-apidocs-home: https://docs.spring.io/spring-security/reference/{spring-security-version}/api/java/org/springframework/security/oauth2/client/
:spring-security-ref-home: https://docs.spring.io/spring-security/reference/{spring-security-version}/servlet/oauth2/login/core.html
:spring-security-reactive-ref-home: https://docs.spring.io/spring-security/reference/{spring-security-version}/reactive/oauth2/login/core.html

[[boot-configuration]]
== Spring Boot Configuration

When using the Spring CredHub starter dependency, Spring CredHub can be configured with {spring-boot-external-config}[Spring Boot application properties].
...
Refer to the {spring-security-reactive-ref-home}#webflux-oauth2-login-override-boot-autoconfig[Spring Security documentation] for more information and examples of configuring other beans.
