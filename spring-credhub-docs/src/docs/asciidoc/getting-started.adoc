:spring-webflux: https://docs.spring.io/spring-framework/reference/{spring-version}/web/webflux.html
...
----
    dependencies {
        api "org.springframework.credhub:spring-credhub-starter:{revnumber}"
    }
----
...
----
    dependencies {
        api "org.springframework.boot:spring-boot-starter-webflux:{spring-boot-version}"
    }
----
...
----
    dependencies {
        api "org.springframework.security:spring-security-config:{spring-security-version}"
        api "org.springframework.security:spring-security-oauth2-client:{spring-security-version}"
    }
----
